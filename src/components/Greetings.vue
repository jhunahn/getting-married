<template>
  <div ref="greeting" class="greetings">
    ...
    <div class="parents">
      <p class="text-int">
        <strong class="parents-name tt">{{ detail.groom.father }}</strong>
        <strong class="parents-name tt">{{ detail.groom.mother }}</strong>
        <em class="tt">의 {{ detail.groom.sibling }}</em>
        <strong class="tt">{{ detail.groom.name }}</strong>
      </p>

      <p class="text-int">
        <strong class="parents-name tt">{{ detail.bride.father }}</strong>
        <strong class="parents-name tt">{{ detail.bride.mother }}</strong>
